                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        autoComplete="email"
                        className="w-full h-11 pl-10 pr-4 bg-white/6 border border-white/12 rounded-xl text-sm text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-brand-red/60 focus:border-brand-red/60 transition-all duration-200"
                      />
                    </div>
                    {errors.email && (
